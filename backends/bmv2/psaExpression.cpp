...
Util::IJson* PsaExpressionConverter::get(const IR::Expression* expression) const {
...
void PsaExpressionConverter::postorder(const IR::BoolLiteral* expression)  {
...
void PsaExpressionConverter::postorder(const IR::Constant* expression)  {
    auto result = new Util::JsonObject();
...
void PsaExpressionConverter::postorder(const IR::ArrayIndex* expression)  {
    auto result = new Util::JsonObject();
...
const IR::Parameter*
PsaExpressionConverter::enclosingParamReference(const IR::Expression* expression) {
...
void PsaExpressionConverter::postorder(const IR::Member* expression)  {
...
Util::IJson* PsaExpressionConverter::fixLocal(Util::IJson* json) {
...
void PsaExpressionConverter::postorder(const IR::Mux* expression)  {
    auto result = new Util::JsonObject();
    map.emplace(expression, result);
...
void PsaExpressionConverter::postorder(const IR::IntMod* expression)  {
    auto result = new Util::JsonObject();
    map.emplace(expression, result);
    result->emplace("type", "expression");
    auto e = new Util::JsonObject();
...
void PsaExpressionConverter::postorder(const IR::Operation_Binary* expression)  {
    binary(expression);
}

void PsaExpressionConverter::binary(const IR::Operation_Binary* expression) {
    auto result = new Util::JsonObject();
    map.emplace(expression, result);
    if (simpleExpressionsOnly) {
        ::error("%1%: expression to complex for this target", expression);
...
void PsaExpressionConverter::saturated_binary(const IR::Operation_Binary* expression) {
...
void PsaExpressionConverter::postorder(const IR::ListExpression* expression)  {
...
void PsaExpressionConverter::postorder(const IR::Operation_Unary* expression)  {
    auto result = new Util::JsonObject();
    map.emplace(expression, result);
    if (simpleExpressionsOnly) {
        ::error("%1%: expression to complex for this target", expression);
...
void PsaExpressionConverter::postorder(const IR::TypeNameExpression* expression)  {
    (void)expression;
}

void PsaExpressionConverter::postorder(const IR::Expression* expression)  {
    BUG("%1%: Unhandled case", expression);
}
...
Util::IJson* PsaExpressionConverter::convertWithConstantWidths(const IR::Expression* e) {
